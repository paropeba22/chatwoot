...
const {
  ...
  GIT_SHA: gitSha,
  GT_UI_V2_ENABLED: gtUiV2Enabled,
  ...
  LOGO: logo,
  LOGO_DARK: logoDark,
  OPERATIONS_CONSOLE_TITLE: operationsConsoleTitle,
  OPERATIONS_STATUS_TEXT: operationsStatusText,
  OPERATIONS_AI_DISPLAY_NAME: operationsAiDisplayName,
...
const state = {
  ...
  displayManifest,
  gitSha,
  gtUiV2Enabled: parseBoolean(gtUiV2Enabled),
  ...
  logoDark,
  logoThumbnail,
  operationsConsoleTitle,
  operationsStatusText,
  operationsAiDisplayName,
  privacyURL,
  termsURL,
  widgetBrandURL,

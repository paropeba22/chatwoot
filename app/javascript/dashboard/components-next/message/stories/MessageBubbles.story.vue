...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about Grupo Telecom?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
  ...
  getMessage({
    ...
    contentAttributes: {
      email: {
        ...
        subject: 'Update on Grupo Telecom Integration and Features',
        textContent: {
          full: "Hi Team,\r\n\r\nI hope this email finds you well! I wanted to share some updates regarding\r\nour integration with *Grupo Telecom* and outline some key features we’ve\r\nexplored.\r\n------------------------------\r\nKey Updates\r\n\r\n   1.\r\n\r\n   *Integration Status*:\r\n   The initial integration with Grupo Telecom has been successful. We've tested:\r\n   - API connectivity\r\n      - Multi-channel messaging\r\n      - Real-time chat updates\r\n   2.\r\n\r\n   *Upcoming Tasks*:\r\n   - Streamlining notification workflows\r\n      - Enhancing webhook reliability\r\n      - Testing team collaboration features\r\n\r\n*Note:*\r\nDon’t forget to check out the automation capabilities in Grupo Telecom for\r\nhandling repetitive queries. It can save a ton of time!\r\n\r\n------------------------------\r\nFeatures We Love\r\n\r\nHere’s what stood out so far:\r\n\r\n   - *Unified Inbox*: All customer conversations in one place.\r\n   - *Customizable Workflows*: Tailored to our team’s unique needs.\r\n   - *Integrations*: Works seamlessly with CRM and Slack.\r\n\r\n------------------------------\r\nAction Items For Next Week:\r\n\r\n   1. Implement the webhook for *ticket prioritization*.\r\n   2. Test *CSAT surveys* post-chat sessions.\r\n   3. Review *analytics dashboard* insights.\r\n\r\n------------------------------\r\nData Snapshot\r\n\r\nHere’s a quick overview of our conversation stats this week:\r\nMetric Value Change (%)\r\nTotal Conversations 350 +25%\r\nAverage Response Time 3 minutes -15%\r\nCSAT Score 92% +10%\r\n------------------------------\r\nFeedback\r\n\r\n*Do let me know if you have additional feedback or ideas to improve our\r\nworkflows. Here’s an image of how our Grupo Telecom dashboard looks with recent\r\nchanges:*\r\n\r\n[image: Grupo Telecom Dashboard Screenshot]\r\n------------------------------\r\n\r\nLooking forward to hearing your thoughts!\r\n\r\nBest regards,\r\n~ Shivam Mishra\r\n",
          reply:
            "Hi Team,\n\nI hope this email finds you well! I wanted to share some updates regarding\nour integration with *Grupo Telecom* and outline some key features we’ve\nexplored.\n------------------------------\nKey Updates\n\n   1.\n\n   *Integration Status*:\n   The initial integration with Grupo Telecom has been successful. We've tested:\n   - API connectivity\n      - Multi-channel messaging\n      - Real-time chat updates\n   2.\n\n   *Upcoming Tasks*:\n   - Streamlining notification workflows\n      - Enhancing webhook reliability\n      - Testing team collaboration features\n\n*Note:*\nDon’t forget to check out the automation capabilities in Grupo Telecom for\nhandling repetitive queries. It can save a ton of time!\n\n------------------------------\nFeatures We Love\n\nHere’s what stood out so far:\n\n   - *Unified Inbox*: All customer conversations in one place.\n   - *Customizable Workflows*: Tailored to our team’s unique needs.\n   - *Integrations*: Works seamlessly with CRM and Slack.\n\n------------------------------\nAction Items For Next Week:\n\n   1. Implement the webhook for *ticket prioritization*.\n   2. Test *CSAT surveys* post-chat sessions.\n   3. Review *analytics dashboard* insights.\n\n------------------------------\nData Snapshot\n\nHere’s a quick overview of our conversation stats this week:\nMetric Value Change (%)\nTotal Conversations 350 +25%\nAverage Response Time 3 minutes -15%\nCSAT Score 92% +10%\n------------------------------\nFeedback\n\n*Do let me know if you have additional feedback or ideas to improve our\nworkflows. Here’s an image of how our Grupo Telecom dashboard looks with recent\nchanges:*\n\n[image: Grupo Telecom Dashboard Screenshot]\n------------------------------\n\nLooking forward to hearing your thoughts!\n\nBest regards,\n~ Shivam Mishra",
          quoted:
            'Hi Team,\n\nI hope this email finds you well! I wanted to share some updates regarding\nour integration with *Grupo Telecom* and outline some key features we’ve\nexplored.',
        },
        to: ['shivam@Grupo Telecom.com'],
      },
      ccEmail: null,
      bccEmail: null,
    },
    attachments: [
      ...
      getAttachment('file', 'https://Grupo Telecom.dev/invoice.pdf'),
      getAttachment('file', 'https://Grupo Telecom.dev/logs.txt'),
      getAttachment('file', 'https://Grupo Telecom.dev/contacts.xls'),
      getAttachment('file', 'https://Grupo Telecom.dev/customers.csv'),
      getAttachment('file', 'https://Grupo Telecom.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://Grupo Telecom.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://Grupo Telecom.dev/all-files.tar'),
      getAttachment(
        'audio',

...
<template>
  <button
    class="gt-editor-mode-toggle flex items-center w-auto h-8 p-1 transition-all border rounded-lg group relative duration-150 ease-out z-0 active:scale-[0.995] active:duration-75"
  ...
  >
    ...
    <div
      class="gt-editor-mode-indicator absolute rounded-md h-6 w-[var(--chip-width)] ease-in-out translate-x-[var(--translate-x)] rtl:translate-x-[var(--rtl-translate-x)]"
      :class="{
        'transition-all duration-150': !disabled && !isReplyRestricted,
      }"
      :style="{
        '--chip-width': width,
